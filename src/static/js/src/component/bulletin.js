/**
 * Created by carina on 17/3/8.
 */

var bulletinComponent = Vue.extend({
    props:['setting'],
    data: function(){
        return {
            extendClass:{'bulletin':true}
        }
    },
    template: __inline('../template/_bulletin-mini.html?__inline'),
    methods:{
    },
    created: function () {
        /*var $this = this;
...
var bulletinFormComponent = Vue.extend({
    data: function(){
        return {
            setting:{},//必要
            show:false,//必要
    ...
    template: __inline('../template/_bulletin-form.html?__inline'),
    created: function () {
        console.log()

    },
});
Vue.component('bulletin-form', bulletinFormComponent);