...
var iconComponent = Vue.extend({
    ...
    data: function(){
        return {
            extendClass:{'icon':true}
        }
    },
    template: __inline('../template/_icon-mini.html?__inline'),
    methods:{
    },
    created: function () {
...
var iconFormComponent = Vue.extend({
    data: function(){
        return {
            setting:{
                data:[]
    ...
    template: __inline('../template/_icon-form.html?__inline'),
    created: function () {
        //console.log()
        /*var $this = this;
...
Vue.component('icon-form', iconFormComponent);