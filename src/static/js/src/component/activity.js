...
var activityComponent = Vue.extend({
    ...
    data: function(){
        return {
            extendClass:{'activity':true}
        }
    },
    template: __inline('../template/_activity-mini.html?__inline'),
    methods:{
    },
    created: function () {
        /*var $this = this;
...
Vue.component('activity', activityComponent);

var activityFormComponent = Vue.extend({
    data: function(){
        return {
            setting:{},//必要
            show:false,//必要
    ...
    template: __inline('../template/_activity-form.html?__inline'),
    created: function () {
        console.log()

    },
});
Vue.component('activity-form', activityFormComponent);