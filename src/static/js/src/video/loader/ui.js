...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    var showImg = $("<img class='dddd' src="+__inline("../../../../img/loading.gif")+"/>");

    progressNameTd.append(Wrapper);

    if (!isImg) {
        showImg.attr('src', __inline('../../../../img/default.png'));
        ...
        $(img).on('load', function() {
            ...
            function initImg(url, key, height) {
                ...
                modalBody.find('img').attr('src', __inline('../../../../img/loading.gif'));
