...
router.post('/pc/save', function (req, res) {
    ...
    redis.del('promotion:'+key , function(err, result){
...
/*
 列表删除
 */
router.get('/pc/list/remove', function (req, res) {
    var query = req.query,
...
/*
 开启关闭
 */
router.get('/pc/list/changeState', function (req, res) {
    var query = req.query;
    redis.del("promotion:"+query.urlkey , function(err , result){
        if(!err){
            models.Canvas.update({
                state: query.state
            }, {
